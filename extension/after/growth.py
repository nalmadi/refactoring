...
def main(argv): 
    ...
    h1.width(2)
    h1.color((0.5, 0.4, 0.3))
    h1.place(x-150, y, z)
    turtles.drawString(qstr, distance, angle, 5, 2)
    h1.place(x, y, z)
    turtles.drawString(qstr1, distance, angle, 5, 2)
    h1.place(x + 150, y, z)
    turtles.drawString(qstr2, distance, angle, 5, 2)
    h1.place(x-650, y+500, z)
    turtles.drawString(mstr, distance, angle, 5, 2)
    h1.place(x, y+500, z)
    turtles.drawString(mstr1, distance, angle, 5, 2)
    h1.place(x+650, y+600, z)
    turtles.drawString(mstr2, distance, angle, 5, 2)
