...
#game object class to be inherited?
...
def collide(ball, paddle_1, paddle_2):
...
def score_point(score_player1, score_player2, ball, pen)
    pen.clear()
...
def main():
    ...
    # Keyboard bindings
    #make into function? don't wanna break it
    ...
    while True:
        ...
        if ball.xcor() > 350:
            score_player1 += 1
            score_pont(score_player1, score_player2, ball, pen)

        elif ball.xcor() < -350:
            score_player2 += 1
            score_pont(score_player1, score_player2, ball, pen)
        
        collide(ball, paddle_1, paddle_2)
